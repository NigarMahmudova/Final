    ...
    public partial class AllTablesCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ColorLanguages", x => new { x.ColorId, x.LanguageId });
                    table.ForeignKey(
                        name: "FK_ColorLanguages_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ColorLanguages_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SliderLanguages", x => new { x.SliderId, x.LanguageId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagLanguages", x => new { x.TagId, x.LanguageId });
                    table.ForeignKey(
                        name: "FK_TagLanguages_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagLanguages_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductColorSizes", x => new { x.ProductId, x.ColorId, x.SizeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ColorLanguages_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagLanguages_LanguageId",
                table: "TagLanguages",
                column: "LanguageId");
        }
